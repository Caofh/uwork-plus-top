  ...
  >
    ...
    >
      ...
      <div class="relative h-96">
        <div
          class="step-loader-container relative mx-auto mt-40 flex max-w-xl flex-col justify-start"
        >
...
<script setup>
  ...
  const props = defineProps({
    ...
    defaultDuration: { type: Number, required: false, default: 1500 },
    preventClose: { type: Boolean, required: false, default: false },
  })

  const emit = defineEmits(['state-change', 'complete', 'close'])
