...
function Toast({ toast, onDismiss, onClick }: ToastProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'pointer-events-auto flex w-80 cursor-pointer items-start gap-3 rounded-xl border border-border bg-background p-3 shadow-lg transition-all duration-200 ease-out bg-card',
        visible && !leaving
