...
function MainApp() {
  ...
  return (
    <>
    <div className="quickforge-app-shell flex h-screen min-h-0 bg-background text-foreground">
      <ChatSidebar
      ...
      <main className="quickforge-main-surface flex min-w-0 flex-1 flex-col">
        <header className="quickforge-topbar flex h-14 shrink-0 items-center gap-2 border-b border-border px-3">
          <Button variant="ghost" size="icon" className="quickforge-icon-button md:hidden" onClick={() => setMobileSidebarOpen(true)} aria-label={t('toggleSidebar')}>
          ...
          <div className="min-w-0 flex-1">
            {scheduledTasksOpen ? (
              <>
                <div className="truncate text-xs font-medium text-muted-foreground/60">AI Workspace</div>
                <div className="truncate text-sm font-medium text-foreground/90">{t('scheduledTasks')}</div>
              </>
            ) : (
              <>
                ...
                <div className="truncate text-sm font-medium text-foreground/90">{sessionTitle(agentManager.currentTitle)}</div>
              </>
            )}
          </div>
          ...
          <Button
            ...
            title="Workspace"
            className="quickforge-icon-button hidden lg:inline-flex"
          >
          ...
          <Button
            ...
            aria-label="分享到局域网"
            title="分享到局域网"
            className="quickforge-icon-button"
          >
        ...
        <section className="quickforge-content-stage relative flex min-h-0 flex-1 flex-col">
          {scheduledTasksOpen ? (
              ...
              <>
                <div className="quickforge-chat-card flex min-h-0 flex-1 flex-col">
                  <ErrorBoundary>
                    <ChatPanelHost
