...
export function openCustomOnlyModelSelector(
  ...
  dialog.className = 'flex max-h-[80vh] w-full max-w-lg flex-col overflow-hidden rounded-lg border border-border bg-background text-foreground shadow-xl bg-card'
