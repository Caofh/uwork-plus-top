...
class ToolbarConfig extends BaseClass {
  ...
  private fullscreenHandler: ((isFullScreen: boolean) => void) | null = null;
  ...
  private setupFullscreenListener(): void {
    this.fullscreenHandler = (isFullScreen: boolean) => {
      this.isFullScreen = isFullScreen;
      this.updateToolbarForFullScreen();
    };
    
    eventBus.on('fullscreen-changed', this.fullscreenHandler);
  }

  // ---------------------初始化函数-----------------------

  private updateToolbarForFullScreen(): void {
    this.toolbars = this.initToolbar();
    this.initToolbarOrderMap();
    this.emit(ToolbarEvents.TOOLBAR_RESET, this.toolbars);
  }
  ...
  private initToolbar(): ToolbarItem[] {
    if (this.isFullScreen) {
      ...
      return [...this.defaultToolbars.filter((toolbar) => toolbar.type !== "contents")];
    }
  }
  ...
  public destroy(): void {
    ...
    if (this.fullscreenHandler) {
      eventBus.off("fullscreen-changed", this.fullscreenHandler);
